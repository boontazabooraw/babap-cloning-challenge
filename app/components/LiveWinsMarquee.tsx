...
const winners: Winner[] = [
  ...
  { game: "imgi_20_1.webp", name: "A*n***", winnings: "950.00" },
  ...
  { game: "imgi_20_1.webp", name: "B*n***", winnings: "1,250.00" },
